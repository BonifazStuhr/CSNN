...
class Cifar10Provider(ADataProvider):
    """
    The Cifar10Provider reads the Cifar10 dataset and provides the dataset in various forms.
    The Cifar10Provider is not responsible for augmenting the dataset!
    """
    ...
    def __init__(self, train_size=50000, eval_size=0, test_size=10000, prepreporcessing_type=""'None'"",
        ...
        """
        super().__init__(dataset_path=os.path.join('data', 'Cifar10'),
                         ...
                         tfrecord_shapes={"data":data_shape, "label":[10]},
    ...
    def getNumReadInBatches(self, mode):
        ...
        """
        # No need to implement this function for Cifar10, because Cifar10 can be read at once.
        raise NotImplementedError('Not implemented for Cifar10Provider')
    ...
    def getNextReadInBatchInNumpy(self, mode):
        ...
        or if onehot (read_in_batch_size, 10).
        """
        # No need to implement this function for Cifar10, because Cifar10 can be read at once.
        raise NotImplementedError('Not implemented for Cifar10Provider')
